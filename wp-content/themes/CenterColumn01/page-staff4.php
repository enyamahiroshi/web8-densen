...
<div class="wrap_800px">
  ...
  <div class="kobetsu-staff_box clr">
    ...
    <div class="kobetsu-staff_meta clr">
      <div class="kobetsu-staff_name">Ｙリーダー</div>
  ...
  <div class="staff_kobetsu_box">
    ...
    <dl class="staff_kobetsu-list">
      ...
      <dd class="clr">
        <div class="f_l">
          <img src="<?php echo get_template_directory_uri(); ?>/img/staff/ph_04-1.jpg" alt="Ｙリーダー：仕事内容について" />
        </div>
  ...
  <div class="staff_kobetsu_box">
    ...
    <div class="carrier_wrap">
      <div class="carrier_box">
        <img class="carrierpass" src="<?php echo get_template_directory_uri(); ?>/img/staff/staff4-carrier.png" alt="Ｙリーダー キャリアパス" />
      </div>
      ...
      <div class="carrier_yamaura_comment">
    	...
    	<img class="carrier_photo" src="<?php echo get_template_directory_uri(); ?>/img/staff/ph_04-2.jpg" alt="Ｙリーダー キャリアパスの写真1" />
    </div>
  </div>
