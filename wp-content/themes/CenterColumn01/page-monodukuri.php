...
<section class="mono_top_main">
		...
		<div class="btn_area">
			<div class="wrap_button">
				...
				<div class="onrobot_btn">
					<a href="<?php echo esc_url(home_url('/')); ?>business/monodukuri/onrobot/"><img src="<?php echo get_template_directory_uri(); ?>/img/monodukuri/btn_onrobot.png" alt="OnRobotページへ"></a>
				</div>
			</div><!--/.wrap_button-->
