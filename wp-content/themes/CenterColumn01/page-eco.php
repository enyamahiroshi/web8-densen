...
-->
		...
		<div class="foot_btn_densetsu tuimin clr">
			<div class="txt_top">ライフソリューション営業本部・お問合せ</div>
      ...
      <table class="tuimalesan">
				<tbody>
					<tr>
						<th class="tuminwi"><span>■</span>介護福祉サポート事業部</th>
						<td class="tel tuiminnss"></td>
					</tr>
					<tr>
						<th class="tuminwi" style="text-align:right;">長野南店　</th>
						<td class="tel tuiminnss"><i class="fa fa-phone-square"></i>&nbsp;026-299-6165</td>
					</tr>
					<tr>
						<th class="tuminwi" style="text-align:right;">上田店　</th>
						<td class="tel tuiminnss"><i class="fa fa-phone-square"></i>&nbsp;0268-28-6170</td>
					</tr>
				</tbody>
			</table>
			<div class="link_access"><a href="https://www.densen.co.jp/kaigo/">介護福祉サポート事業部のホームページはこちら</a></div>
