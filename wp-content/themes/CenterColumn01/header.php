...
<link href="<?php echo get_template_directory_uri(); ?>/onrobot/css/layout.css" rel="stylesheet">
<link href="<?php echo get_template_directory_uri(); ?>/onrobot/css/onrobot.css" rel="stylesheet">
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/onrobot/js/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/onrobot/js/jquery.matchHeight-min.js"></script>
<?php endif; ?>
...
<?php endif ?>
  ...
  <div class="inner_mv_text-home">
	...
	<?php
      $args = array( "category_name" => "news,event", "posts_per_page" => 1 ); //ニュースカテゴリ　最新の記事1件
  ...
  <?php endif; //ここまで：HOMEのみ ?>
	...
	<?php if(is_home()): ?>
		<?php // デジタルハンドブックリンクバナー （スマホのみ表示：PCはWP「メニュー」から追加したものを site.css で表示・非表示） ?>
		<?php /*
		<div class="bnr_degitalhandbook">
			<a href="https://www.densen.co.jp/ecatalog/" target="_blank" rel="noopener noreferrer">
				<img src="<?php echo get_template_directory_uri(); ?>/img/common/bnr_book.png" alt="">
			</a>
		</div>
		*/ ?>
		<?php //最新の記事1件----(SP) ?>
...
<section class="contents_nav_wrap">
  <ul class="contents_nav">
	...
	<li>
		<a href="https://www.densen.co.jp/kaigo/">
