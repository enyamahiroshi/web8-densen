...
<div class="staff_box clr">
  ...
  <div class="staff_img">
	...
	<?php //名前・肩書 ?>
	<div class="staff_meta clr">
  	<div class="staff_name">Ｔ課長代理</div>
...
<div class="staff_box clr">
  <?php //写真 ?>
  <div class="staff_img">
  	<a href="<?php echo esc_url(home_url('/')); ?>recruit/staff/staff3/"><img src="<?php echo get_template_directory_uri(); ?>/img/staff/ph_03.jpg" alt="Ａ支店長" /></a>
  </div>
	<?php //名前・肩書 ?>
	<div class="staff_meta clr">
  	<div class="staff_name">Ａ支店長</div>
...
<div class="staff_box clr">
  <?php //写真 ?>
  <div class="staff_img">
  	<a href="<?php echo esc_url(home_url('/')); ?>recruit/staff/staff4/"><img src="<?php echo get_template_directory_uri(); ?>/img/staff/ph_04.jpg" alt="Ｙ社員" /></a>
  </div>
	<?php //名前・肩書 ?>
	<div class="staff_meta clr">
  	<div class="staff_name">Ｙ社員</div>
