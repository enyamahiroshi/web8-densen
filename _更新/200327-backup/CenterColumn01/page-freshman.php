...
Ａ.まずは、今ある形を大切にしていきたいと思います。
    ...
    <li>
      <img src="<?php echo get_template_directory_uri(); ?>/img/freshman/staff003.jpg" alt="2017年入社 営業3" /><div class="AnswerArea">私は、説明会の時のアットホームな雰囲気に惹かれ、デンセンで働きたいと思いました。<br>配属から1ヶ月もしないうちに先輩から誘って頂いたりと、本当に気さくな先輩が多く働きやすいです。やる気があればあるほど、自分が成長できる。<br>そんなところがデンセンの魅力なので、これからは新規開拓などにも挑戦してみたいです。</div>
    </li>
    <!-- li>
...
<a data-slide-index="1" href=""><img src="<?php echo get_template_directory_uri(); ?>/img/freshman/staff008.jpg" alt="2019年入社 介護福祉サポート事業部所属" /></a>
...
<a data-slide-index="2" href=""><img src="<?php echo get_template_directory_uri(); ?>/img/freshman/staff011.jpg" alt="2019年入社 住宅ソリューション営業部所属" /></a>
<a data-slide-index="3" href=""><img src="<?php echo get_template_directory_uri(); ?>/img/freshman/staff012.jpg" alt="2019年入社 長野支店所属" /></a>
  <a data-slide-index="4" href=""><img src="<?php echo get_template_directory_uri(); ?>/img/freshman/staff002.jpg" alt="2017年入社 営業2" /></a>
  <a data-slide-index="5" href=""><img src="<?php echo get_template_directory_uri(); ?>/img/freshman/staff003.jpg" alt="2017年入社 営業3" /></a>
