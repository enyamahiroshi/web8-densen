...
<div class="wrap_800px">
  ...
  <div class="kobetsu-staff_box clr">
    ...
    <div class="kobetsu-staff_meta clr">
      <div class="kobetsu-staff_name">Ａ支店長</div>
  ...
  <div class="staff_kobetsu_box">
    ...
    <dl class="staff_kobetsu-list">
      ...
      <dd class="clr">
        <div class="f_l">
          <img src="<?php echo get_template_directory_uri(); ?>/img/staff/ph_03-1.jpg" alt="Ａ支店長：仕事内容について" />
        </div>
  ...
  <div class="staff_kobetsu_box">
    ...
    <div class="carrier_wrap">
      <div class="carrier_box">
        <img class="carrierpass" src="<?php echo get_template_directory_uri(); ?>/img/staff/staff3_2-carrier.png" alt="Ａ支店長 キャリアパス" />
      </div>
      <div class="carrier_mokuhyo">
    	...
    	<img class="carrier_photo" src="<?php echo get_template_directory_uri(); ?>/img/staff/ph_03-2.jpg" alt="Ａ支店長 キャリアパスの写真1" />
    </div>
  </div>
